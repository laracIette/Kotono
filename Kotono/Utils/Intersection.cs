...
namespace Kotono.Utils
{
    internal static class Intersection
    {
        ...
        internal static bool IntersectRayTriangle(in Vector rayOrigin, in Vector rayDirection, in Triangle triangle, out Vector intersectionLocation, out float intersectionDistance)
        {
            ...
            var vertex1 = (Vector)Vector3.TransformPosition((Vector3)triangle.Vertices[0], triangle.Transform.Model);
            var vertex2 = (Vector)Vector3.TransformPosition((Vector3)triangle.Vertices[1], triangle.Transform.Model);
            var vertex3 = (Vector)Vector3.TransformPosition((Vector3)triangle.Vertices[2], triangle.Transform.Model);
